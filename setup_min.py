...
def main():
    ...
    ci_cmake_generator = (
        ["-G", "Visual Studio 17 2022", '-DCMAKE_C_FLAGS_RELEASE=/GL /O2 /Ot', '-DCMAKE_SHARED_LINKER_FLAGS_RELEASE=/LTCG /OPT:REF /OPT:ICF']
        if os.name == "nt"
    ...
    cmake_args = (
        ...
        + [
            ...
            "-DWITH_GDCM=OFF",
            "-DWITH_HPX=OFF",
            "-DWITH_OPENMP=ON",  # 并行编程 多核处理器加速计算
